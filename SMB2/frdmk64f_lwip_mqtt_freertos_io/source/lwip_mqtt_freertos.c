...
{
    static const char *topics[] = {"jimenez1/feeds/welcome-feed"}; //Changed added key from adafruit-->feed-->feed info
...
{
    static const char *topic   = "jimenez1/feeds/welcome-feed";//cambio a key de adifruit-->feeds-->feed info
    static const char *message = "Hola broker";
